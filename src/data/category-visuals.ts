...
export const categoryVisuals: Record<string, CategoryVisual> = {
  'two-way-radio': {
    icon: 'radio',
    banner: '/images/products/two-way-radio-banner.webp',
    bannerAlt: '工业通信现场中的专业对讲机设备',
    objectPosition: 'center center',
  },
  'shortwave-radio': {
    icon: 'radio-tower',
    banner: '/images/products/shortwave-radio-banner.webp',
    bannerAlt: '山地环境中的远距离短波通信设备',
    objectPosition: 'center center',
  },
  'mesh-network': {
    icon: 'network',
    banner: '/images/products/mesh-network-banner.webp',
    bannerAlt: '工业现场中的多节点无线自组网系统',
    objectPosition: 'center center',
  },
  'ict-integration': {
    icon: 'server',
    banner: '/images/products/ict-integration-banner.webp',
